...
echo ================================================================
echo.
echo Select action or build type:
echo   [1] Debug                (Dev build, fast, default SDK debug key)
echo   [2] Release              (Release build, optimized / R8, release key)
echo   [3] Debug (Release Key)  (Fast compilation, signed with release key)
echo   [4] Clean Project        (Run gradlew clean to wipe build caches)
echo   [0] Exit
echo.
set "BUILD_CHOICE="
set /p "BUILD_CHOICE=Enter choice [1/2/3/4/0] (default: 1): "
...
if "%BUILD_CHOICE%"=="3" goto SET_DEBUG_RELEASE
if /i "%BUILD_CHOICE%"=="dr" goto SET_DEBUG_RELEASE
if /i "%BUILD_CHOICE%"=="debug-release" goto SET_DEBUG_RELEASE
if "%BUILD_CHOICE%"=="4" goto DO_CLEAN
if /i "%BUILD_CHOICE%"=="clean" goto DO_CLEAN
if /i "%BUILD_CHOICE%"=="c" goto DO_CLEAN
...
echo.
echo ================================================================
echo [INFO] Running task: gradlew.bat clean
echo ================================================================
echo.
...
:SET_DEBUG_RELEASE
set "BUILD_TYPE=debug"
set "BUILD_TYPE_NAME=Debug (Release Key)"
set "GRADLE_TASK=assembleDebug -PsignDebugWithRelease=true"
goto START_BUILD
